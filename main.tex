...
\thispagestyle{empty}
\begin{center}
\resizebox{0.8\textwidth}{!}{\includegraphics{images/logo_tcm_upc_docs.png}}\\
...
\resizebox{0.5\textwidth}{!}{\includegraphics{images/logo_tcm.png}}\\
